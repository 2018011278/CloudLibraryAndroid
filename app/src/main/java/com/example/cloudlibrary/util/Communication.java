...
public class Communication {
    ...
    private static final String INDEX = "https://Django-UltimatelsCharging.app.secoder.net/comment/index/";
    ...
    private static final String NET = "https://Django-UltimatelsCharging.app.secoder.net/";
    ...
    public void addComment(final Comment comment){
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/comment/save/");
    ...
    public boolean  confirmAdmin(String account,String password){
        ...
        Thread temp = new Thread(() -> {
            try{
                URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/accounts/verify/"+ TYPE_EQUAL +"verify"+"&account="+a+"&password="+p);
                HttpURLConnection urlConn= (HttpURLConnection) url .openConnection();
                InputStreamReader in=new InputStreamReader (urlConn.getInputStream()) ;
                int responseCode = urlConn.getResponseCode();
                in.close ();
    ...
    public JSONArray getIndexNews(int start, int end){
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/article/"+ TYPE_EQUAL +"get_title"+ START_EQUAL +start+ END_EQUAL +end);
            jsonArray = getUrl(url).getJSONArray("data");
        } catch (MalformedURLException | JSONException e) {
            Log.d("context", String.valueOf(e));
        }
    ...
    public int getVisited (String title){
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/visit/"+ TYPE_EQUAL +"get_visit"+"&position="+title);
    ...
    public String getNewsUrl(String title){
        String t = "";
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/article/"+ TYPE_EQUAL +"get_url"+"&title="+title);
    ...
    public JSONObject getInformation(String pos) throws JSONException {
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/detail/point/?type=get_info&pos="+pos);
    ...
    public JSONArray getFloorPoint(String floor,String pos){
        JSONArray jsonArray = null;
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/detail/point/?type=get_axis&library="+pos+ FLOOR_EQUAL + floor);
            jsonArray = getUrl(url).getJSONArray("data");
        } catch (MalformedURLException | JSONException e) {
            Log.d("context", String.valueOf(e));
        }
    ...
    public String getFloorFullImage(String pos,String floor) throws JSONException {
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/detail/floor/?type=get_floor&library="+ pos + FLOOR_EQUAL + floor);
    ...
    public String getWelcomeImage() throws JSONException {
        String urls = NET;
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/welcome/?type=get_welcome");
    ...
    public void addGrade(final String grade){
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/grade/");
            Map<String,String> param = new HashMap<>();
    ...
    public void addVisited(final String position){
        ...
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/visit/");
            Map<String,String> param = new HashMap<>();
    ...
    public JSONArray getGrade(){
        JSONArray jsonArray = null;
        try {
            URL url = new URL("https://Django-UltimatelsCharging.app.secoder.net/grade/?type=get_grade");
            jsonArray = getUrl(url).getJSONArray("data");
        } catch (MalformedURLException | JSONException e) {
            Log.d("context", String.valueOf(e));
        }
